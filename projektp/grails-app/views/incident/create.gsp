...
<html>
	...
	<body>
		<a href="#create-incident" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-incident" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${incidentInstance}" var="error">
