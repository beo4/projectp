...
<html>
	<head>
		<meta name="layout" content="bootstrapPrint">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<dl>
					...
					%>
					<gvisualization:lineCoreChart  vAxis="${new Expando(format:'#',gridlines:{count: 9})}" curveType="none" elementId="lineChart_div" columns="${colums}" title="${title }" data="${chartData }" width="${600}" height="${600}"/>
